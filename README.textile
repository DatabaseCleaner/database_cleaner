...
ActiveRecord, DataMapper, Sequel, MongoMapper, Mongoid, CouchPotato, and Ohm are supported.
...
h2. Features in this fork

Add **Ohm** orm support which uses Truncation strategy.
...
(with orm Ohm, :only and :except accept options like "Widget:Name*" or "*:id*" that redis command KEYS accept)
...
| Ohm           | DatabaseCleaner[:ohm]           | Connection specified as redis url                                        |
